  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 xl:grid-cols-2 gap-6">
        {/* Weekly schedule — AI builds it, auto-saves, sidebar for history */}
        <SchedulePanel
          userId={userId}
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
          ...
          {!gradPlan ? (
            <div className="flex flex-col items-center justify-center py-16 text-center px-6">
              <div className="w-12 h-12 rounded-full bg-emerald-50 border border-emerald-100 flex items-center justify-center text-2xl mb-3">
                🎓
              </div>
              <p className="text-sm font-medium text-gray-600">No graduation plan yet</p>
              <p className="text-xs text-gray-400 mt-1">
                Ask GradAI:{" "}
                <span className="italic">"Plan my remaining semesters until graduation"</span>
              </p>
            </div>
          ) : (
                  ...
                  <table className="w-full">
                    <thead>
                      <tr className="border-b border-gray-100">
                        <th className="text-left px-5 py-2 text-[10px] font-semibold text-gray-400 uppercase tracking-wider w-24">
                          Course
                        </th>
                        <th className="text-left px-3 py-2 text-[10px] font-semibold text-gray-400 uppercase tracking-wider w-12">
                          Cr
                        </th>
                    ...
                    <tbody>
                      {sem.courses.map((course, j) => (
                        ...
                        >
                          <td className="px-5 py-2 text-xs font-mono font-semibold text-blue-600">
                            {course.code}
                          </td>
